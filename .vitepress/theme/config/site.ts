export const siteConfig = {
    name: 'shadcn extended',
    url: 'https://shadcn-extended.vercel.app/',
    ogImage: 'https://shadcn-extended.vercel.app/og.png',
    description: 'Extednded components for shadcn/vue',
    links: {
...
export const announcementConfig = {
    icon: '✨',
    title: 'Extended: Now available!',
    link: '/docs/components/introduction.html',
}
