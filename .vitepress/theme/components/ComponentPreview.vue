...
function transformImportPath(code: string) {
  ...
  s.replaceAll(`@/lib/registry/default`, codeConfig.value.componentsPath)
...
watch([style, codeConfig], async () => {
  try {
    rawString.value = await import(`../../../src/lib/registry/default/example/${props.name}.vue?raw`).then(res => res.default.trim())
