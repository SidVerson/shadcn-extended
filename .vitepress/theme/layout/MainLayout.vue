...
import { Toaster as DefaultSonner } from '@/lib/registry/default/ui/sonner'
import { TooltipProvider } from '@/lib/registry/default/ui/tooltip'
...
<template>
  <TooltipProvider>
    ...
    <div v-else vaul-drawer-wrapper class="flex min-h-screen flex-col bg-background">
      ...
      <DefaultToaster />
      <DefaultSonner class="pointer-events-auto" :theme="'system'" />
    </div>
  </TooltipProvider>
</template>
